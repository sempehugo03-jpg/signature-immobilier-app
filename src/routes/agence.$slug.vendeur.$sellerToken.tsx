  ...
  return (
    <SaasShell action={<HomeLink />}>
      <SaasHero
        ...
        action={<StatusBadge status={property.publicStatus} />}
      />
      ...
      <section className="mx-auto max-w-7xl px-5 pb-16 md:px-8">
        ...
        <div className="grid gap-7 lg:grid-cols-[1.12fr_0.88fr]">
            ...
            <SaasCard className="p-6 md:p-8">
              ...
              <div className="mt-6 space-y-4">
                {agencyConfig.saleProgress.slice(0, 6).map((step, index) => {
                  ...
                  const done = index <= Math.max(currentIndex, 0);
                  return (
          ...
          <aside className="space-y-7">
            <Panel icon={<CalendarDays className="h-4 w-4" />} title="Prochaine visite">
            ...
            <Panel icon={<Clipboard className="h-4 w-4" />} title="Compte rendu">
