...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [
        ...
        { title: "Signature Immobilier — Biens premium et estimation" },
        {
          name: "description",
          content:
            "Découvrez les biens à vendre et demandez une estimation avec Signature Immobilier.",
        },
        {
          property: "og:title",
          content: "Signature Immobilier — Biens premium et estimation",
        },
        {
